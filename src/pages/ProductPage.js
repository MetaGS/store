            ...
            <Container>
                ...
                <div className="product-page-content">
                    ...
                    <section className="product-page-photo-block">
                        <div className="product-page-photo"><img src={productPhoto} alt="product" /></div>
                        ...
                        <SeeMoreProducts />
                    </section>{/* product-page-photo block end */}
                    ...
                    <section className="product-page-desc-block">
                        ...
                        <h2 className="product-page-title">Self Lacing Battery Shoes
                            mmid iately show that</h2>
                        ...
                        <div className="product-page-sizes">
                            <div className="sub-block"><span className="sub-block-title">sizes</span>
                                <span className="sub-block-guide"><a href="#">Size guide</a></span>
                            </div>
                            <div className="sizes-self">
                                {
                                    <>
                                        <div className="row"> {sizes.slice(0, 5).map(size => {
                                            return (
                                                <div className="size"><span>{size}</span></div>
                                            )
                                        })}
                                        </div>
                                        <div className="row"> {sizes.slice(5).map(size => {
                                            return (
                                                <div className="size"><span>{size}</span></div>
                                            )
                                        })}
                        ...
                        <div className="product-page-colors">
                            <div className="sub-block"><span className="sub-block-title">Colors</span></div>
